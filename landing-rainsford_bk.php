		...
		<div class="hero-boxes">
			<div class="box1">
				<div class="container">
					<div class="row">
						<div class="col s10">
							<p><?php echo esc_html( medman_meta( $post_id, 'hero_text_1' ) ); ?></p>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="container">
			<div class="row work-cards-row">
				<div class="col s12 m6">
					<div class="card">
						<div class="card-content">
				          	<span class="card-title"><?php echo esc_html( medman_meta( $post_id, 'work_card1_title' ) ); ?></span>
				...
				<div class="col s12 m6">
					<div class="card">
						<div class="card-content">
				          	<span class="card-title"><?php echo esc_html( medman_meta( $post_id, 'work_card2_title' ) ); ?></span>
